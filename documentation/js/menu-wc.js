...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">proyecto2 documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/Accesorios.html" data-type="entity-link" >Accesorios</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Camisetas.html" data-type="entity-link" >Camisetas</a>
                            </li>
                            <li class="link">
                                <a href="components/Cesta.html" data-type="entity-link" >Cesta</a>
                            </li>
                            <li class="link">
                                <a href="components/Chaquetas.html" data-type="entity-link" >Chaquetas</a>
                            </li>
                            <li class="link">
                                <a href="components/Home.html" data-type="entity-link" >Home</a>
                            </li>
                            <li class="link">
                                <a href="components/Pantalones.html" data-type="entity-link" >Pantalones</a>
                            </li>
                            <li class="link">
                                <a href="components/Pie.html" data-type="entity-link" >Pie</a>
                            </li>
                            <li class="link">
                                <a href="components/SeccionUsuario.html" data-type="entity-link" >SeccionUsuario</a>
                            </li>
                            <li class="link">
                                <a href="components/Zapatos.html" data-type="entity-link" >Zapatos</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/UsuarioRegistro-1.html" data-type="entity-link" >UsuarioRegistro</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
